# file: 'books/src/config.py'

# Copyright 2017 Alex Kleider
...
"""
MODULE books.src.config

Part of the Double Entry Book Keeping rewrite using Django interface.
